    ...
    <main className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50">
      <section className="px-6 py-20 md:py-28 text-center">
        ...
        <div className="mt-10 flex items-center justify-center gap-4">
          <a href="/legacy" className="px-6 py-3 rounded-full text-white font-semibold bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 transition-colors">今すぐ始める</a>
      ...
      <section id="features" className="px-6 py-16 md:py-24 bg-white/70">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-2xl md:text-3xl font-bold text-gray-900 text-center">主要機能</h2>
      ...
      <section className="px-6 py-16 md:py-24 text-center">
        ...
        <div className="mt-8 flex items-center justify-center gap-4">
          <a href="/legacy" className="px-6 py-3 rounded-full text-white font-semibold bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 transition-colors">アカウント作成 / ログイン</a>
          {/* サブスク廃止に伴いCheckoutボタンを削除 */}
          {/* 将来の他課金手段導入時にここへ差し替え可 */}
        </div>
      </section>
    </main>
  )
